...
namespace HalloDoc_Project.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        {
            var result = await (from physician in _context.Physicians
                                join region in _context.Physicianregions on physician.Physicianid equals region.Physicianid into phy
                                select physician).Where(s => s.Regionid == regionid).ToListAsync();
            return Json(result);
        }
        [HttpPost]
